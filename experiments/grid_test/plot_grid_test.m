...
%%
% partial
load(sprintf('results-k-%i-nrep-%i-partial.mat',20,48));
gridname = 'partial';

%%
% k=20, nrep=48
k=20; nrep=48;
load(sprintf('results-k-%i-nrep-%i.mat',k,nrep));
gridname=sprintf('grid-k-%i-n-%i',k,nrep);
...
print(gcf,'-depsc2','-cmyk',[gridname '-fval.eps']);
...
print(gcf,'-depsc2','-cmyk',[gridname '-ncorr.eps']);
...
print(gcf,'-depsc2','-cmyk',[gridname '-all-bw.eps']);